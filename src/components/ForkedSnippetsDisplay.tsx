...
const ForkedSnippetsDisplay: FC<ForkedSnippetsDisplayProps> = () => {
    ...
    console.log("snippets forkedsnippetsdisplay: ", snippets);
    ...
    useEffect(() => {
        ...
        async function fetchSnippets() {
            try {
                ...
                console.log("api/get-forked frontend result: ", data);
...
const SnippetCard = ({ snippet }: { snippet: Snippet }) => {
    ...
    const handleFork = (snippetId: number) => {
        fetch("/api/fork", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            ...
            <div className="p-3 border-b border-gray-700 flex items-center">
                ...
                <div className="ml-auto flex gap-2">
                    ...
                    <span className="text-gray-400 text-xs flex items-center gap-1">
                        ...
                        <span className="cursor-pointer" onClick={() => handleFork(parseInt(snippet.id))}>
                            0 forks
                        </span>
                    </span>
                    <span className="text-gray-400 text-xs flex items-center gap-1">
                        ...
                        <span className="cursor-pointer" onClick={() => handleStarring(parseInt(snippet.id))}>
                            0 stars
                        </span>
                    </span>
                </div>
